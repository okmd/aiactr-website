		...
		<div class="col-xs-12 col-sm-offset-3 col-sm-6 col-sm-offset-3 col-md-offset-3 col-md-6 col-md-offset-3 col-lg-4 col-lg-4 col-lg-offset-4">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="text-center"><?php echo$head;?></h3>
				</div>
			<div class="panel-body">
				<?php echo form_open("entry/admin/login");?>
				<?php if(isset($er)){?>
			...
			<div class="panel-footer">
				<h5 class="text-center"><a href="#">Dont't try to login</a></h5>
				<h5 class="text-center"><a href="#">Back</a></h5>
				<h5 class="text-center">Only for Authorised user</h5>
			</div>
			</div>
		</div>
	</div>
